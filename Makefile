...
SRCS_MAN=	ft_calloc.c ft_isprint.c ft_memset.c ft_split.c ft_strlcat.c ft_strnstr.c ft_toupper.c ft_isalnum.c\
				...
				ft_striteri.c ft_strmapi.c ft_substr.c ft_bzero.c ft_isdigit.c ft_memmove.c ft_putstr_fd.c ft_strjoin.c ft_strncmp.c ft_tolower.c
SRCS_BONUS=	ft_lstdelone_bonus.c ft_lstsize_bonus.c ft_lstiter_bonus.c ft_lstadd_back_bonus.c ft_lstlast_bonus.c\
			ft_lstadd_front_bonus.c ft_lstmap_bonus.c ft_lstclear_bonus.c ft_lstnew_bonus.c 
